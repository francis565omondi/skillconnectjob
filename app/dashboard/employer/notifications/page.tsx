              ...
              <main className="flex-1 space-y-6 p-6">
                ...
                <div className="flex items-center justify-between">
                  <div>
                    ...
                    <div className="text-slate-600">
                      ...
                      {unreadCount > 0 && (
                        <span className="ml-2">
                          <Badge className="bg-gradient-to-r from-orange-400 to-pink-500 text-white border-0 rounded-xl text-xs">
                            {unreadCount} unread
                          </Badge>
                        </span>
                      )}
                ...
                <div className="space-y-4">
                  {filteredNotifications.map((notification) => (
                    <Card
                      key={notification.id}
                      className={`simple-card hover:shadow-md transition-all duration-200 ${
                    ...
                    >
                      <CardContent className="p-6">
                        <div className="flex items-start space-x-4">
                          <div
                            className={`w-12 h-12 bg-gradient-to-br ${notification.color} rounded-xl flex items-center justify-center flex-shrink-0`}
                          >
                          ...
                          <div className="flex-1 min-w-0">
                            ...
                            <p className={`${notification.read ? "text-slate-600" : "text-slate-700"} mb-4 leading-relaxed`}>
