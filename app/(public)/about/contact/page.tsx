...
export default function ContactPage() {
  return (
    <div className="min-h-screen bg-gradient-to-br from-orange-50 via-white to-orange-100">
      <AboutNavbar current="/about/contact" />
      <main className="max-w-2xl mx-auto px-4 py-12 text-center">
        <h1 className="text-3xl font-bold text-orange-700 mb-4">Contact</h1>
        <div className="bg-white/80 rounded-xl shadow p-8">
          <p className="text-lg text-gray-700 mb-2">Want to get in touch? Email us at <span className="text-orange-600 font-semibold">skillconnect2025@gmail.com</span> or use the contact form on our main Contact page.</p>
        </div>
      </main>
    </div>
  );
