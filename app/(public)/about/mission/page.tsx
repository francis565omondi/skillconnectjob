...
export default function MissionPage() {
  return (
    <div className="min-h-screen bg-gradient-to-br from-orange-50 via-white to-orange-100">
      <AboutNavbar current="/about/mission" />
      <main className="max-w-2xl mx-auto px-4 py-12 text-center">
        <h1 className="text-3xl font-bold text-orange-700 mb-4">Mission & Vision</h1>
        <div className="bg-white/80 rounded-xl shadow p-8">
          <p className="text-lg text-gray-700 mb-2">This section will soon detail SkillConnect's mission, vision, and core values.</p>
